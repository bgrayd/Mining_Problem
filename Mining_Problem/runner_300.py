...
out1 = open("total_300.csv","w")
out2 = open("special_300.csv","w")
out3 = open("special_avg_300.csv","w")
out1.write(",")
out2.write(",")
out3.write(",")
for each in As:
...
for a in As:
	for b in Bs:
		p=subprocess.Popen(["..\Release\Mining_Problem_300.exe",str(a),str(b)], stdin=subprocess.PIPE, stdout=subprocess.PIPE)
