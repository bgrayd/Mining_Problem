...
As = [each/10.0 for each in range(-10,10)]#[-1, -0.5, -0.001,0.01, 0.1, 1]#
Bs = [each*10.0 for each in range(-10,10)]#[-2, -1, 0, 10, 50, 100, 1000]#
...
out1 = open("total_100.csv","w")
out2 = open("special_100.csv","w")
out3 = open("special_avg_100.csv","w")
out1.write(",")
out2.write(",")
out3.write(",")
for each in As:
...
for a in As:
	for b in Bs:
		p=subprocess.Popen(["..\Release\Mining_Problem_100.exe",str(a),str(b)], stdin=subprocess.PIPE, stdout=subprocess.PIPE)
