...
out1 = open("total_CD_100.csv","w")
out2 = open("special_CD_100.csv","w")
out3 = open("special_avg_CD_100.csv","w")
out1.write(",")
out2.write(",")
out3.write(",")
for each in As:
...
for a in As:
	for b in Bs:
		p=subprocess.Popen(["..\Release\Mining_Problem_100.exe", str(-1), str(10), str(a),str(b), str(0)], stdin=subprocess.PIPE, stdout=subprocess.PIPE)
